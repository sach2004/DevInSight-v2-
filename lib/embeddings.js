/**
 * WORKING HUGGING FACE EMBEDDINGS - FINAL FIX
 */

/**
 * Generate embedding using the CORRECT Hugging Face API endpoint
 * @param {string} text 
...
export async function generateEmbedding(text) {
  ...
  try {
    ...
    // Use a model that actually works for feature extraction
...
/**
 * Process embeddings with proper delays
